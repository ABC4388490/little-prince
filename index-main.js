const storyData = {
        ...
        function loadLittlePrinceMemory() {
            try {
                ...
                if (!raw) return { emotion: 'neutral', worries: [], likes: [], keywords: [], updatedAt: null, turns: 0 };
                ...
                return {
                    ...
                    turns: typeof obj?.turns === 'number' ? obj.turns : 0,
                };
            } catch (e) {
                return { emotion: 'neutral', worries: [], likes: [], keywords: [], updatedAt: null, turns: 0 };
            }
        }

        function saveLittlePrinceMemory(mem) {
            try {
                localStorage.setItem(LITTLE_PRINCE_MEMORY_KEY, JSON.stringify(mem || {}));
            } catch (e) {}
        }
